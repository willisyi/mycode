...
//#define _XOPEN_SOURCE  600 //201304
#include <stdlib.h>
#include <string.h>
...
#define DE_REQ(x...) fprintf(stderr,x)
...
#endif
#if 0
 {JPEG_FRAME_URI		,NULL		,AUTHORITY_VIEWER   ,URI_FLAG_VIRTUAL_PAGE ,NULL },
    {"/ipcam/mjpeg.cgi"		,NULL		,AUTHORITY_VIEWER   ,URI_FLAG_VIRTUAL_PAGE ,NULL },
    {"/ipcam/mjpegcif.cgi"	,NULL		,AUTHORITY_VIEWER   ,URI_FLAG_VIRTUAL_PAGE ,NULL },
    {"/ipcam/mpeg4.cgi"		,NULL		,AUTHORITY_VIEWER   ,URI_FLAG_VIRTUAL_PAGE ,NULL },
    {"/ipcam/mpeg4cif.cgi"	,NULL	,AUTHORITY_VIEWER   ,URI_FLAG_VIRTUAL_PAGE ,NULL },
    {"/ipcam/avc.cgi"		,NULL		,AUTHORITY_VIEWER   ,URI_FLAG_VIRTUAL_PAGE ,NULL },
    {"/ipcam/avccif.cgi"	,NULL		,AUTHORITY_VIEWER   ,URI_FLAG_VIRTUAL_PAGE ,NULL },
#endif	
    ...
    if (req->http_uri) {
		if((strcmp(req->request_uri,"/")!= 0) && (strcmp(req->request_uri,"/gIPNC-ro.gz")!= 0) && (strcmp(req->request_uri,"/IPNCWebDlls.CAB")!= 0) &&
			...
			if (req->http_uri->authority < req->authority) {
				...
				DE_REQ("req->http_uri->authority %d\t req->quthority %d\n",req->authority);
				if (req->http_uri->authority < req->authority) {
...
int process_option_line(request * req)
{
    ...
    *value++ = '\0';            /* overwrite the : */
    ...
    else if (!memcmp(line,"AUTHORIZATION",14) && !req->authorization)
    {
		...
		DE_REQ("requestl.c L4973! value = %s\n",req->authorization);
    }
#endif
