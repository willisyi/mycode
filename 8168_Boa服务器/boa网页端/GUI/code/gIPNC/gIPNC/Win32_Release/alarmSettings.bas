...
\***************************************************************************************/
/*
Ä this page Ä view and set alarm setting.
*/
 ...
 * Description: Ä this Ä Ä fetch values from camera and assign
 * the values Ä form controls.
...
Äh loadInitialValues  
 ...
 ÄB retVal = 0 Ä  
 Ä addItemsToDropDown("ddStorageDur",arrStorageDuration$,storageDuration)
 Ä addItemsToDropDown("ddinput",arrExtInpTriger$,exttriggerinput) 
 Ä addItemsToDropDown("ddoutput",arrExtOutTriger$,exttriggeroutput)
 Ä addItemsToDropDown("ddftp",arrFtpFormat$,ftpFormat)
 Ä addItemsToDropDown("ddsmtp",arrSmtpFormat$,smtpFormat)
 Ä addItemsToDropDown("ddlocstorage",arrLocalFormat$,localFormat)
 Ä addItemsToDropDown("ddSelectAlarm",audioFiles$,audioFiles) 
 ÄD
 ...
 * Description: Ä this Äh Ä disable/enable check box and drop down 
 based on the drop down values

 * Created by: Vimala On 2009-11-06 13:11:55
 ***********************************************************/
Äh checkOnAlarm()
 ÄB #ddftp.itemcount>0 Ä
 ÄB #ddftp.itemlabel$(0) = "N/A" Ä  
 ...
 ÄB #ddsmtp.itemcount>0 Ä
 ÄB #ddsmtp.itemlabel$(0) = "N/A" Ä  
 ...
 ÄB #ddLocStorage.itemcount>0 Ä
 ÄB #ddLocStorage.itemlabel$(0) = "N/A" or  checkSDInsertValue()= 1 Ä  
 ...
 * Description: Ä this Äh Ä set FG,BG,BRDR color
 ...
 ***********************************************************/
Äh setCtrlProperty(dimi disableFlag,dims chkName$,dimi bgCol, dimi fgCol, dimi brdCol,dims lblName$,dims drpName$,dims lblattachfile$,dims txtName$) 
 #{chkName$}.checked = 0
 ...
 #{drpName$}.selbg = bgCol
 ÄB chkName$="chksmtp" or chkName$="chkLocalStorage" Ä
 #{lblattachfile$}.fg = fgCol
 #{lblattachfile$}.selfg = fgCol  
 #{txtName$}.fg = fgCol
 #{txtName$}.selfg = fgCol  
 ÄB chkName$="chksmtp" Ä 
 #{txtName$}.bg = bgCol  
 #{txtName$}.selbg = bgCol
 #{txtName$}.brdr = bgCol
 ...
 * Description: Ä1 gray image based on the condition
 ...
 * ÄB proprty is invalid set unchecked
 * Params:
 ...
 * History: 
 ***********************************************************/
Äh setCheckBox(dims ctrlName$, dimi propValue) 
 Ä propValue <> 0 and propValue <> 1 Ä propValue = 0
 ...
 * Description: Checks Ä minimum and maximum number of files
 * attached.
 * Set user input control values Ä the camera.  
...
Äh savePage() 
 ...
 ÄB  (#txtattachfile < smtpMinFiles or #txtattachfile > smtpMaxFiles) and (#chksmtp.checked = 1) Ä
 Ä("The attached file numbers must be between "+smtpMinFiles+" and "+smtpMaxFiles)
 Äd("txtattachfile")
 Ä
 ÄD  
...
Äh displaySaveStatus(dimi saveStatus)
 ...
 ÄC 
 Ä("Alarm setting failed for the camera "+~title$)
 ÄD
 ÄD
 ...
 * Description: Ä CheckExternalTriggers Ä Ä 
 * enable or disable controls
 
 * Created by:vimala  On 2009-04-07 12:53:58
 ***********************************************************/
Äh chkExternalTriggers_Click
 Ä CheckExternalTriggers()
ÄF

/***********************************************************

 * Description: Ä this Ä Ä enable or disable 
 * corresponding controls
 
 * Created by: vimala On 2009-04-07 12:57:39
 ***********************************************************/
Äh checkExternalTriggers()
 
 ÄB #chkExternalTriggers.checked = 1 Ä
 #ddInput.disabled = 0
 #ddOutput.disabled = 0
 ÄC 
 #ddInput.disabled = 1
 ...
 * Description: Ä checkLocalStorage Ä Ä  
 * enable or disable controls
 ...
 ***********************************************************/
Äh checkLocalStorage()
 
 ÄB #chkLocalStorage.checked = 1 Ä
 ...
 * Description: Ä checkplayAudio Ä Ä  
 * enable or disable controls
 
 * Created by: vimala On 2009-04-07 14:18:27

 ***********************************************************/
Äh chkplayAudio_Click  
 Ä checkplayAudio() 
ÄF
 ...
 * Description: Checks entered key value based on the rule set Ä that user input control  
 * 
 * Params:
...
Äh txtAttachFile_Focus
 rule = 7 
 Ä #txtattachfile.disabled = 1 Ä Ä∂(0)
ÄF

Äh txtAttachFile_blur
 Ä∂(3)
ÄF

Äh chkEnableAlarm_Focus
 Ä #chkEnableAlarm.disabled = 0 Ä Ä∂(1)
ÄF


Äh chkdarkblank_Focus
 Ä∂(3)
ÄF


Äh chkEnableAlarm_Blur
 Ä∂(3)
ÄF

Äh chkMotionDet_Focus
 Ä #chkMotionDet.disabled = 0 Ä  Ä∂(1)
ÄF

Äh chkexternaltriggers_Focus
 Ä #chkexternaltriggers.disabled = 0 Ä  Ä∂(1)
ÄF

Äh chkExternalTriggers_Blur
 Ä∂(3)
ÄF

Äh chkFTP_Focus
 Ä #chkftp.disabled = 0 Ä  Ä∂(1)
ÄF
...
Äh chkplayAudio_Focus
 Ä #chkplayAudio.disabled = 0 Ä  Ä∂(1)
ÄF

Äh chkplayAudio_Blur
 Ä∂(3)
ÄF

Äh optLocalStorage_Focus  
 Ä #optlocalStorage.disabled = 0 Ä Ä∂(1)
ÄF
 ...
 * Description: Gray out all the controls ÄB enable alarm is disabled
 *
 * Created by:Vimala On 2009-11-06 12:17:59
 ***********************************************************/
Äh chkEnableAlarm_Click  
 
 ÄB #chkenablealarm.checked = 0 Ä  
 ...
 * Description: Ä this Ä Ä gray out controls
 ...
 * History: 
 ***********************************************************/
Äh grayOutCtrls(dimi disableFlag,dimi bgColor,dimi fgColor,dimi brdrColor,dimi selBGColor) 
 dimi i
 Ä i = 1 Ä noofctrl-1
 Ä LabelName$(i)
 Ä LabelName$(i) = "lblCamera" Ä continue  
 Ä LabelName$(i) = "roCamera" Ä continue  
 Ä Ä&(LabelName$(i),"cmd")>=0 Ä continue  
 #{LabelName$(i)}.disabled = disableFlag
 #{LabelName$(i)}.fg = fgColor
 #{LabelName$(i)}.selfg = fgColor

 ÄB Ä&(LabelName$(i),"dd")>=0 or Ä&(LabelName$(i),"txt")>=0  Ä
 #{LabelName$(i)}.fg = brdrColor
 #{LabelName$(i)}.selfg = brdrColor  
 #{LabelName$(i)}.bg = bgColor  
 #{LabelName$(i)}.brdr = bgColor  
 Ä disableFlag = 0 Ä #{LabelName$(i)}.brdr = brdrColor  
