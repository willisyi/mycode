...
LabelName$(0) = "gdosdExplorer" : XPos(0) = 248: YPos(0) = 115: Wdh(0) = 264: Height(0) = 128
LabelName$(1) = "cmdBack" : XPos(1) = 248: YPos(1) = 558: Wdh(1) = 100: Height(1) = 20
LabelName$(2) = "cmdFormat" : XPos(2) = 248: YPos(2) = 81: Wdh(2) = 100: Height(2) = 20
LabelName$(3) = "cmdMount" : XPos(3) = 366: YPos(3) = 81: Wdh(3) = 100: Height(3) = 20
LabelName$(4) = "lblupdate" : XPos(4) = 458: YPos(4) = 283: Wdh(4) = 162: Height(4) = 30
...
Äh Form_Load
 ...
 #gdosdExplorer.h = #cmdback.y - 60 - #cmdback.w
 ...
 * History: 
 ***********************************************************/
 Äh gdosdExplorer_BeforeNavigate(DimS Page$) 
 Ä  Page$
 dimi spltCount
 dims temp$,url$
 Ä Page$
 spltCount = Ä<(temp$,Page$,",")
 
 ÄB spltCount = 6 Ä
 url$ = Äà(temp$(5),"\"","")
 Ä url$ 
 ÄB url$ = ~camAddPath$+"sdget.htm" or (Ä&(url$,".avi") >= 0 and Ä&(url$,"sddel.htm") = -1) Ä
 #cmdback.hidden = 1
 ÄC 
 #cmdback.hidden = 0
 ÄD
 ...
 * Description: Clicking on  Ä$ button will Ä$ the SD explorer.
...
Äh cmdFormat_Click  
 ...
 ret = Ä5(~camAddPath$ + "vb.htm?sdformat=1", "","",2,0,~authHeader$,,,responseData$)
 
 ÄB ret >= 0 Ä
 status$ = Ä#(Äå(responseData$,3))
 ...
 Ä "SD Card Format Successful"
 ÄC 
 Ä "SD Card Format Failed"
 ÄD
 ÄC 
 Ä "SD Card Format Failed"  
 ÄD 
 ...
 * Description:Ä Mount/Unmountthe SD card.
...
Äh cmdMount_Click
 ...
 ÄB #cmdmount$ = "Unmount"  Ä  
 mountVal = 1
 Äy #cmdmount$ = "Mount" Ä
 mountVal = 8
 ÄD
 
 retVal = Ä5(~camAddPath$ + "vb.htm?sdunmount="+mountVal, "","",2,0,~authHeader$,,,responseData$)
 
 ÄB retVal >= 0 Ä
 status$ = Ä#(Äå(responseData$,3))
 
 ÄB status$ = "OK" Ä
 Ä "SD Card "+#cmdmount$+" Successful"
 ÄC 
 Ä "SD Card "+#cmdmount$+" Failed"
 ÄD
 ÄC 
 Ä "SD Card "+#cmdmount$+" Failed"  
 ÄD 
