...
option(4+1)
dimi previousIndex=-1  
Dimi flagAudio=1  
dimi flagAllstreams=0  
dimi flagSnap=0  
...
LabelName$(0) = "ddStream" : XPos(0) = 352: YPos(0) = 70: Wdh(0) = 111: Height(0) = -1
LabelName$(1) = "chkDispallstreams" : XPos(1) = 259: YPos(1) = 141: Wdh(1) = 144: Height(1) = 14
LabelName$(2) = "ddExample" : XPos(2) = 845: YPos(2) = 70: Wdh(2) = 111: Height(2) = -1
LabelName$(3) = "imgsnap" : XPos(3) = 538: YPos(3) = 70: Wdh(3) = 40: Height(3) = 40
LabelName$(4) = "imgalarm" : XPos(4) = 584: YPos(4) = 70: Wdh(4) = 40: Height(4) = 40
LabelName$(5) = "imgrecord" : XPos(5) = 630: YPos(5) = 70: Wdh(5) = 40: Height(5) = 40
LabelName$(6) = "imgaudio" : XPos(6) = 676: YPos(6) = 70: Wdh(6) = 40: Height(6) = 40
LabelName$(7) = "gdobg" : XPos(7) = 286: YPos(7) = 198: Wdh(7) = 678: Height(7) = 388
LabelName$(8) = "lblSelectStream" : XPos(8) = 259: YPos(8) = 70: Wdh(8) = 86: Height(8) = 14
LabelName$(9) = "lblExample" : XPos(9) = 780: YPos(9) = 70: Wdh(9) = 57: Height(9) = 14
LabelName$(10) = "frmSnap" : XPos(10) = 450: YPos(10) = 115: Wdh(10) = 398: Height(10) = 66
LabelName$(11) = "imgsdCard" : XPos(11) = 723: YPos(11) = 70: Wdh(11) = 40: Height(11) = 40
LabelName$(12) = "imgDisplay1x" : XPos(12) = 492: YPos(12) = 70: Wdh(12) = 40: Height(12) = 40
LabelName$(13) = "txtSnapText" : XPos(13) = 564: YPos(13) = 125: Wdh(13) = 213: Height(13) = -1
LabelName$(14) = "optStorage" : XPos(14) = 564: YPos(14) = 153: Wdh(14) = 83: Height(14) = 14
LabelName$(15) = "optStorage[1]" : XPos(15) = 656: YPos(15) = 153: Wdh(15) = 55: Height(15) = 14
LabelName$(16) = "optStorage[2]" : XPos(16) = 718: YPos(16) = 153: Wdh(16) = 62: Height(16) = 14
LabelName$(17) = "btnOk" : XPos(17) = 785: YPos(17) = 125: Wdh(17) = 57: Height(17) = 20
LabelName$(18) = "btnCancel" : XPos(18) = 785: YPos(18) = 153: Wdh(18) = 57: Height(18) = 20
LabelName$(19) = "lblSnapText" : XPos(19) = 462: YPos(19) = 125: Wdh(19) = 98: Height(19) = 14
LabelName$(20) = "lblSaveTo" : XPos(20) = 462: YPos(20) = 153: Wdh(20) = 56: Height(20) = 14
LabelName$(21) = "lblLoad" : XPos(21) = 564: YPos(21) = 273: Wdh(21) = 192: Height(21) = 31
...
Dims prvscreen1$,prvscreen2$,prvscreen3$,prvscreen4$,prvScreen5$,prvScreen6$  
dimi toolTipPaintFlag = 0
Dims stream$(3),rtspUrl$(3)
Dimi ddstreamNo
ddstreamNo = Ä(ÄÉ("ddstreamNo"))
Dimi disp1xFlag
disp1xFlag = Ä(ÄÉ("disp1xFlag"))
dimi democfg  
dims ~videoPlayerVersion$  
 ...
 * Ä the LoadStreamValue Ä, Ä load the stream name into drop down box.
 * Create video player(GDO) Ä display video.
...
Äh form_load  
 ...
 Ä rtspUrl$(0);rtspUrl$(1);rtspUrl$(2)
 ÄB stream$(0) = "" Ä
 Ä "Streams not available"
 Ä_("!auth.frm")
 ÄD  
 ...
 calVideoDisplayRatio(#ddstream.itemlabel$(#ddstream.selidx),xRatio,yRatio) 
 ...
 * Description: Enable/Disable audio Ä video player
...
Äh toolTip_mouseOver(x,y)
 ÄB x>=#imgDisplay1x.x and x<=(#imgDisplay1x.x+#imgDisplay1x.w) and y>=#imgDisplay1x.y and y<=(#imgDisplay1x.y+#imgDisplay1x.h) Ä  
 Ä clearToolTip
 Ä[(#imgDisplay1x.x,#imgDisplay1x.y+TOOLTIP_HEIGHT+30,TOOLTIP_WIDTH1+60,TOOLTIP_HEIGHT,1,1,TOOLTIP_TXT_BG,TOOLTIP_TXT_BG)
 Ä^(#imgDisplay1x.x,#imgDisplay1x.y+TOOLTIP_HEIGHT+30,"1X Display",TOOLTIP_TXT_STYLE,TOOLTIP_TXT_FG,TOOLTIP_TXT_FONT)
 Ä1(#imgDisplay1x.x, #imgDisplay1x.y+TOOLTIP_HEIGHT+30, TOOLTIP_WIDTH1+60, TOOLTIP_HEIGHT)
 Äy x>=#imgsnap.x and x<=(#imgsnap.x+#imgsnap.w) and y>=#imgsnap.y and y<=(#imgsnap.y+#imgsnap.h) Ä  
 Ä clearToolTip
 Ä[(#imgsnap.x+10,#imgsnap.y+TOOLTIP_HEIGHT+30,TOOLTIP_WIDTH1,TOOLTIP_HEIGHT,1,1,TOOLTIP_TXT_BG,TOOLTIP_TXT_BG)
 ...
 Ä clearToolTip
 Ä[(#imgalarm.x+10,#imgalarm.y+TOOLTIP_HEIGHT+30,TOOLTIP_WIDTH2,TOOLTIP_HEIGHT,1,1,TOOLTIP_TXT_BG,TOOLTIP_TXT_BG)
 ...
 Ä clearToolTip
 Ä[(#imgrecord.x+10,#imgrecord.y+TOOLTIP_HEIGHT+30,TOOLTIP_WIDTH3,TOOLTIP_HEIGHT,1,1,TOOLTIP_TXT_BG,TOOLTIP_TXT_BG)
 ...
 Ä clearToolTip
 Ä[(#imgaudio.x+10,#imgaudio.y+TOOLTIP_HEIGHT+30,TOOLTIP_WIDTH3,TOOLTIP_HEIGHT,1,1,TOOLTIP_TXT_BG,TOOLTIP_TXT_BG)
 ...
 Ä clearToolTip
 Ä[(#imgsdcard.x+10,#imgsdcard.y+TOOLTIP_HEIGHT+30,TOOLTIP_WIDTH4,TOOLTIP_HEIGHT,1,1,TOOLTIP_TXT_BG,TOOLTIP_TXT_BG)
...
Äh clearToolTip
 ...
 Ä“(prvScreen6$,#imgDisplay1x.x,#imgDisplay1x.y+TOOLTIP_HEIGHT+30,5,1) 
 ÄD
 ...
 * Description: 
 * check box click event Ä load allStreamsVideo.frm
...
Äh chkDispallstreams_Click
 ...
 ÄB flagAllstreams=0 Ä
 flagAllstreams=1
 Äy flagAllstreams=1 Ä
 flagAllstreams=0
 ÄD
 Ä ~wait <1 Ä Ä 
...
Äh form_timer
 ~wait = ~wait +1  
 Ä ~wait > 1 Ä #chkdispallstreams.disabled = 0  
 ...
 animateCount ++
 animateLabel("lblload",dispstr$) 
 ÄC
 
 ÄB audioStatusFlag = 1 Ä
 Ä displaySaveStatus(audioStatusFlag)
 ÄC
...
Äh displayAlarmStatus() 
 ...
 Ä "alarmData";alarmData
 
 
 Ä Ä$("%x",ANDB(alarmData,0x000F)) 
 ...
 * Description: Hide snap frame ÄB flagSnap is set.
 * show snap frame ÄB flagSnap is not set.
 ...
 * Description: Ä set the audio flag and toggle the image 
 subsequent Ä the audio flag
 * 
 * 
 * Params:
...
ÄB canReload = 1 Ä
 ...
 animateCount = 1
 dispstr$ = "Updating"
 Ä animateLabel("lblload",dispstr$)
 ...
 * Description: 
 * Ä store the previous screen and repaint the screen after showing 
 the tooltip
...
Äh getPreviousScreen
 ...
 Ä—(prvScreen6$, #imgDisplay1x.x+10,#imgDisplay1x.y+TOOLTIP_HEIGHT+30,TOOLTIP_WIDTH4+10,TOOLTIP_HEIGHT+10) 
ÄF
 ...
 * Description: 
 * Ä set focus Ä the control

 * Created by: Franklin  On 2009-07-16 14:01:12
 ***********************************************************/
Äh txtsnaptext_focus  
 rule = 17 //rule set Ä alphanumeric and undercore
 Ä∂(3)
ÄF
 ...
 * Description: 
 * Ä set the URL(required stream) during the change event
 * 
 * Params:
 ...
 * Description: 
 * Ä set the URL Ä the video player(GDO) Control
 * 
...
Äh disp_streams()
 ...
 dims url$,value$
 dimi ret,a
 Ä previousIndex=#ddstream.selidx and imgsnapFlag=0 Ä Ä
 ...
 * Description: Ä load the Display1x From

 * Created by: On 2009-10-01 19:00:24

 ***********************************************************/
Äh imgDisplay1x_Click  
 ÄB canReload = 1 Ä
 Dimi streamNo
 streamNo = Ä(#ddstream$)
 Ä_("!display1xMode.frm&streamNo="+streamNo)
 ÄD
ÄF
 ...
 * Description: Ä this Ä Ä get the camera restart Ä 
