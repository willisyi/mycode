...
\***************************************************************************************/
/*
This screen allows user Ä view and set motion detection.
*/
...
dims motionBlock$
Ä loadMotionSettingsValues()


/***********************************************************

 * Description: 
 * Set the properties Ä gdo video control(select all motionblocks)

 * Created by: Partha Sarathi.K On 2009-03-03 16:02:27
 ***********************************************************/
Äh btnSelectAll_Click
 ...
 * Description: 
 * Set the properties Ä gdo video control(deselect all motionblocks)

 * Created by: Partha Sarathi.K On 2009-03-03 16:02:27

 ***********************************************************/
Äh btnClearAll_Click
 ...
 * Description: 
 * Set the properties Ä gdo video control(Restore motionblocks)
...
Äh loadMotionSettingsValues()
 ...
 Ä ret = 0 Ä addItemsToDropDown("ddthreshold", motionSettingsName$, sensitivity) 
 ...
 * Save the motion settings Ä the ini files.

 * Created by: Partha Sarathi.K On 2009-03-05 11:39:33

 ***********************************************************/
Äh cmdMotionDetSave_Click
 dimi a
 ÄŸ(1000)
 ...
 ÄB #optThreshold$ = "1" and (#txtthreshold$ < 1 or #txtthreshold$ > 99) Ä  
 Ä "Customized Threshold \nmust be between 1 and 99"
 Äd("txtthreshold")
 Ä
 ÄD
 
 ÄB #ddthreshold.itemcount = 0 Ä 
 ret=-1
 ÄC  
 ...
 ÄB ret >= 0 Ä  
 Ä ("Motion Detection setting \nsaved to camera "+~title$)
 ÄC  
 ÄB ~keywordDetFlag = 1 Ä  
 Ä("Motion Detection setting for \n"+~errorKeywords$+"\nfailed for the camera "+~title$)
 ÄC 
 Ä ("Motion Detection setting \nfailed for the camera "+~title$) 
 ÄD
 ÄD  
 ...
 * Description: Ä create GDO control And set the width & height Ä the 
...
Äh CreateControls
 ...
 Ä getMainVideoPosition(gdoCurX, gdoCurY, gdoCurWidth, gdoCurHeight)
 ...
 ***********************************************************/
Äh getMainVideoPosition(gdoCurX, gdoCurY, gdoCurWidth, gdoCurHeight)
 gdoX = gdoCurX
 gdoY = gdoCurY
 gdoW = gdoCurWidth
 gdoH = gdoCurHeight
 ...
 * Description: Ä displayControls Ä Ä resize control 
 * based on the screen resolution
 * Ä loadAdvanceSettingsValue Ä Ä fetch 
...
Äh loadVideoAnalyticsValue()
 ...
 ÄB retVal = 0 Ä  
 Ä addItemsToDropDown("dddirection",directionName$,direction)
 Ä addItemsToDropDown("ddmaskoption",maskOptionsName$,maskOptions)
 Ä addItemsToDropDown("ddFaceRec",frecognitionName$,faceRecog) 
 Ä addItemsToDropDown("ddfdetect",fdetectname$,facedetect)
 ÄD
 ...
 * Assgin x,Y,W value Ä the modal window.
 * Loads the video.
 * Created by: vimala On 2009-04-03 11:45:08
 * History: 
 ***********************************************************/
Äh cmdconfigure_Click  
 ÄB canReload = 1 Ä
 dimi a
 ...
 #gdobg.hidden=1
 Ä motionBlock$
 Ä disp_streams("gdoVideo")
 Ä optThreshold_Click  
 ...
 * Description: validateCtrlValues() Ä checks Ä valid data.
...
Äh displaySaveStatus(dimi saveStatus)
 ...
 ÄC  
 ÄB ~keywordDetFlag = 1 Ä  
 Ä("Advanced Features setting for\n "+~errorKeywords$+"\nfailed for the camera "+~title$)
 ÄC
 Ä("Advanced Features setting failed for the camera "+~title$)
 ÄD
 ÄD
...
Ä validateCtrlValues()
 ...
 ÄB #txtx$ = "" Ä
 Ä("Enter Region of Interest X")
 Äd("txtx")
 validateCtrlValues = 0
 Ä
 Äy #txty$ = "" Ä
 Ä("Enter Region of Interest Y")
 Äd("txty")
 validateCtrlValues = 0
 Ä
 Äy #txtw$ = "" Ä
 Ä("Enter Region of Interest W")
 Äd("txtw")
 validateCtrlValues = 0
 Ä
 Äy #txth$ = "" Ä
 Ä("Enter Region of Interest H")
 Äd("txth")
 validateCtrlValues = 0
 Ä
 Äy #txtfdconfidence$="" Ä
 Ä("Enter Face Detection Confidence level")
 Äd("txtfdconfidence")
 validateCtrlValues = 0
 Ä
 Äy #txtfdconfidence$<>"" and (#txtfdconfidence<1 or #txtfdconfidence>100) Ä  
 Ä("Face Detect Confidence level should range between 1 - 100 ")
 Äd("txtfdconfidence")
 validateCtrlValues = 0
 Ä  
 Äy #txtfrconfidence$ = "" Ä  
 Ä("Enter Face Recognition Confidence level")
 Äd("txtfrconfidence")
 validateCtrlValues = 0
 Ä
 Äy #txtfrconfidence$<>"" and (#txtfrconfidence<1 or #txtfrconfidence>100) Ä
 Ä("Face Recognition Confidence level should range between 1 - 100 ")
 Äd("txtfrconfidence")
 validateCtrlValues = 0
 Ä
 ÄD
 ...
 * Description: Set the properties Ä gdo video control Ä play rtsp stream
 ...
 * Description: Get Stream and load the rtsp url Ä video player

 * Created by: Franklin Jacques  On 2009-07-31 19:01:44
 ***********************************************************/
Äh disp_streams(dims CtrlName$)
 dims url$,value$
 dimi ret,a  
...
Äh disableConfigureBut(dimi disableFlag,dims ctrlName$)
 ÄB disableFlag = 1 Ä
 #{ctrlName$}.disabled = 1
 #{ctrlName$}.fg = 17004
 #{ctrlName$}.bg = 14826
...
Äh txtFDConfidence_Focus  
 rule = 7 
ÄF

Äh txtFRConfidence_Focus
 rule = 7
ÄF
...
ÄF
*/
Äh optPrivacyMask_Focus
 Ä∂(1)
ÄF

Äh optdatabase_Focus
 Ä∂(1)
ÄF
...
Äh optthreshold_focus
 Ä∂(1)
ÄF

Äh optcusthreshold_focus
 Ä∂(1)
ÄF

Äh optcusthreshold_blur
 Ä∂(3)
ÄF

Äh btnselectall_focus
 Ä∂(3)
ÄF

Äh btnclearall_focus
 Ä∂(3)
ÄF
...
Äh cmdmotiondetsave_focus
 Ä∂(3)
ÄF


Äh cmdmotiondetcancel_focus
 Ä∂(3)
ÄF
 ...
 * Description: 
 * Ä set the focus Ä the controls
 ...
 * enable Configure button ÄC disable.
 ...
 ***********************************************************/
Äh cmdROIConfigure_Click  
 ÄB canReload = 1 Ä
 Ä∂(3)
 Ä #lblloading$ = ~Unable_To_Display_Msg$ Ä Ä
 
 ÄB  ValidateRegionValues() = 0 Ä  
 ...
 regX = ÄY((Ä(#txtx$)*gdoWidth)/xRes)
 regY = ÄY((Ä(#txty$)*gdoHeight)/yRes)
 regW = ÄY((Ä(#txtw$)*gdoWidth)/xRes)
 regH = ÄY((Ä(#txth$)*gdoHeight)/yRes) 
 #gdoVideoROI.RegionOfInterest("1&"+regX+"&"+regY+"&"+regW+"&"+regH+"")
 
 ÄC  
 Ä("Please enter valid X,Y,Width,Height") 
 ÄD
 ÄD
 Äd("rosubmenu[1]")
ÄF
 ...
 * Description: calcuate the ROI coordinates Ä the actual
...
Äh cmdROIOk_Click  
 ...
 #txtw$ = region$(2)
 #txth$ = region$(3)
 Ä cmdROICancel_Click
ÄF


/***********************************************************

 * Description: Calculate ROI coordinates Ä the 
 ...
 * History:Used in  Video Advanced ROI 
 ***********************************************************/
Äh RoiCalculation(byref dims regionArray$()) 
 ...
 /*
 res = ÄY((regX*xRes)/gdoWidth)
 regionArray$(0)=res 
 res = ÄY((regY*yRes)/gdoHeight)
 regionArray$(1)=res  
 res = ÄY((width*xRes)/gdoWidth)
 regionArray$(2)=res  
 res = ÄY((height*yRes)/gdoHeight)
 regionArray$(3)=res */
 ÄD
ÄF
 ...
 * History: 
 ***********************************************************/
Äh cmdROIClear_Click  
 #gdoVideoROI.RegionOfInterest("1&0&0&0&0")
 #gdoVideoROI.ResetMouseFlag = 1  //added by Frank on 15th july 2010 //Ä reset
 Äd("lblroiborder")
ÄF
