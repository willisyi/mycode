...
/*
Login screen.
Load user name and password ÄB remember password is enabled.
 ...
 * Description: Display the BG img Ä login page and display the login controls.
...
Äh Form_paint  
 ...
 #txtpassword.paint(0)
 #cmdsubmit.paint(0)
 #chkRememberPwd.paint(0) 
ÄF

/***********************************************************

 * Description: Ä& the X and Y pos Ä display the login controls.
...
Äh findXYPos()
 ...
 Ä loginImgX < 0 Ä loginImgX = 0
 
 loginImgY = (~menuYRes - LOGIN_BG_H)/2
 Ä loginImgY < 0 Ä loginImgY = 0
 
ÄF

/***********************************************************

 * Description: Set the X and Y pos Ä login controls based on screen resolution.
 
 * Created by: Partha Sarathi.K On 2009-03-06 14:36:25
 ***********************************************************/
Äh setControlPos()
 
 dims ctrlName$(4) = ("txtusername", "txtpassword","chkRememberPwd","cmdsubmit",) 
 dimi i
 dimi yPos
 ...
 ÄB i<>3 Ä  
 #{ctrlName$(i)}.x = loginImgX + 480
 #{ctrlName$(i)}.w = 176
 ÄC
 #{ctrlName$(i)}.x = loginImgX + USER_NAME_X+13
 ÄD
 ...
 * Gets user authority.
 * Redirects Ä live video on successful login.
 * Created by: Partha Sarathi.K On 2009-03-06 15:05:47
 ***********************************************************/
Äh cmdSubmit_Click
 Ä Ä (~debugInfo$) > 9900 Ä ~debugInfo$ = ""
 ...
 Ä "authRet = " + authRet  
 ÄB authRet = -1 Ä
 Ä "Invalid user name or password"
 ÄC
 ...
 * Description: Checks Ä key validation  
 ...
 * Description: Load the user name and password ÄB remember flag is set
 * Created by: Vimala  On 2009-10-22 15:16:48
 * History: 
 ***********************************************************/
Äh Form_Load  
 
 ÄB #chkrememberpwd.checked = 1 Ä 
 dims loginDet$,loginInfo$,tempDet$
 dimi ret,splitcount
 readprofile("IPNC",loginDet$)
 ret = decode(loginDet$,loginInfo$,1)
 splitcount  = Ä<(tempDet$,loginInfo$,":")
 Ä "loginInfo$ = "  + loginInfo$
 ÄB splitcount = 3 Ä 
 #txtusername$ = tempDet$(0)
 #txtpassword$ = tempDet$(1)
 ~authUserName$ = Ä#(#txtusername$)
 ~authPassword$ = Ä#(#txtpassword$) 
 ~rememberPwd = Ä(Ä#(tempDet$(2)))
 ÄC 
 #txtusername$ = ""
 #txtpassword$ = ""
 ÄD
 ...
 ***********************************************************/
Äh chkRememberPwd_Click
 
 ÄB #chkRememberPwd.checked = 0 Ä
 ~rememberPwd = 0
 writeprofile("IPNC","") 
 ÄC
 ~rememberPwd = 1
...
Äh chkRememberPwd_Focus
 Ä∂(1)
ÄF


Äh chkRememberPwd_Blur
 Ä∂(3)
ÄF
