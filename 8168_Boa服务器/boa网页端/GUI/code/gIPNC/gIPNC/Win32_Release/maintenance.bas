...
LabelName$(0) = "lblnote" : XPos(0) = 250: YPos(0) = 513: Wdh(0) = 600: Height(0) = 37
LabelName$(1) = "gdoMaintenance" : XPos(1) = 334: YPos(1) = 70: Wdh(1) = 800: Height(1) = 442
LabelName$(2) = "cmdBack" : XPos(2) = 250: YPos(2) = 555: Wdh(2) = 100: Height(2) = 20
~wait = 2
...
Äh Form_Load
 ...
 ÄB bkupfirmware = 1 Ä  
 #gdomaintenance.navigate$(~camAddPath$+"\MaintJ.htm?bkup=1") 
 ÄC
 ...
 * History: 
 ***********************************************************/
Äh gdomaintenance_BeforeNavigate2(dims Page$) 
 dimi spltCount
 dims temp$,url$
 Ä "Page$ =" + Page$  
 Ä Page$="" Ä Ä
 Ä Ä&(Page$,"\MaintJ.htm\"")
 ÄB Ä&(Page$,"about:blank")=-1  Ä
 ÄB Ä&(Page$,"\MaintJ.htm\"") >= 0 or Ä&(Page$,"/vb.htm?")>=0 or Ä&(Page$,"?bkup=1")>=0 Ä
 #cmdback.hidden = 1
 #lblnote.hidden = 0
 ÄC 
 #cmdback.hidden = 0
 ...
 * Description: Used Ä get value from camera Ä backup and restore firmware
 * 
 * 
 * Params:
 ...
 * History: 
 ***********************************************************/
Ä getFirmwareValue(byref dimi bkupfirmware)
 dims tempVal$
