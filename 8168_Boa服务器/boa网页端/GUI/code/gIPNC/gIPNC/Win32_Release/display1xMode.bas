...
Äh Form_Load
 ...
 Ä streamNo;stream$(streamNo)
 ÄB stream$(streamNo)<>"" Ä 
 
 getCurStreamResolution(stream$(streamNo), xRes, yRes)
 
 // Code modified Ä displaying 1x with scroll buttons inbuilt - START
 ...
 ÄD
 // Code modified Ä displaying 1x with scroll buttons inbuilt - Ä
 ÄD 
 gdoCurWidth = gdoCurWidth/16
 gdoCurWidth = gdoCurWidth*16
 btnX = MaxResX - #btnClose1x.w - 10
 btnY = 5
 Ä btnX;btnY
 #btnClose1x.x = btnX
 #btnClose1x.y = btnY
 ...
 * Description: 
 * Ä close the 1x Mode and Ä back Ä Live Video frm
 * 
 * Params:
 ...
 * Description: 
 * Ä Ä Ä the liveVideo frm  when Esc key is pressed
 * 
 * Params:
...
Äh form_keypress(key , FromMouse)
 ...
 disp1xFlag = 1
 ÄB key = 15 Ä
 Ä_("!LiveVideo.frm&ddstreamNo="+streamNo+"&disp1xFlag="+disp1xFlag)
 ÄD
