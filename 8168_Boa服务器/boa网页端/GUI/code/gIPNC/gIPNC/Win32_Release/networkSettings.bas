...
Äh ShowDefaultValues() 
 ...
 Ä Ä#(ip$) = "" Ä #txtIPaddress$ = defaultValue$
 Ä netmask$
 #txtnetmask$=suppressZero$(netmask$) 
 Ä Ä#(netmask$) = "" Ä #txtnetmask$ = "0.0.0.0"
 #txtgateway$=suppressZero$(defaultGWay$) 
 Ä Ä#(defaultGWay$) = "" Ä #txtgateway$ = "0.0.0.0"
 #txtserver$=suppressZero$(priNameServer$) 
 Ä Ä#(priNameServer$) = "" Ä #txtserver$ = defaultValue$
 ÄC
 Ä("unable to fetch network details")
 ÄD
 
 
 ÄB retFTP<>-1 Ä
 #txtftpserver$=suppressZero$(ftpServer$) 
 Ä Ä#(ftpServer$) = "" Ä #txtftpserver$ = "0.0.0.0"
 #txtftpusername$=username$
 Ä Ä#(username$) = "" Ä #txtftpusername$ = defaultValue$
 #txtftppassword$=ftppwd$
 Ä Ä#(ftppwd$) = "" Ä #txtftppassword$ = defaultValue$
 #txtftpfileuploadpath$=fileUpldpath$
 Ä Ä#(fileUpldpath$) = "" Ä #txtftpfileuploadpath$ = defaultValue$
 #txtftpport$=ftpport
 ÄC
 Ä("unable to fetch FTP details")
 ÄD
 
 
 ÄB retSMTP<>-1 Ä 
 #txtsmtpaccountname$=accName$ 
 Ä Ä#(accName$) = "" Ä #txtsmtpaccountname$ = defaultValue$
 #txtsmtppassword$=smtppwd$ 
 Ä Ä#(smtppwd$) = "" Ä #txtsmtppassword$ = defaultValue$
 #txtsmtpsender$=sender$
 Ä Ä#(sender$) = "" Ä #txtsmtpsender$ = defaultValue$
 //#txtsmtpserver$= suppressZero$(smtpServer$) 
 #txtsmtpserver$= smtpServer$  
 Ä Ä#(smtpServer$) = "" Ä #txtsmtpserver$ = "0.0.0.0"
 #txtsmtpemail$=emailid$
 Ä Ä#(emailid$) = "" Ä #txtsmtpemail$ = defaultValue$
 #Checksmtpserverauth$=requiresAuth  
 
 #txtsmtpport$ = smtpPort
 
 ÄC
 Ä("unable to fetch SMTP details")
 ÄD
 
 
 ÄB retVal<>-1 Ä
 #txtsntpserver$=sntpServer$  
 Ä Ä#(sntpServer$) = "" Ä #txtsntpserver$ = "0.0.0.0"
 #chkrtspmulticast$ = multiCast  
 ÄC
 Ä("unable to fetch SNTP/RTSP details")
 ÄD
 ÄB dhcpenable=1 Ä  
 disableNetwork(1) 
 Äd("txtftpserver")
 ...
 ÄB retPORT<>-1 Ä
 #txtporthttp$=Ä#(httpPort)
 Ä httpPort = 0 Ä #txtporthttp$ = "00"
 #txtporthttps$=Ä#(httpsport)
 Ä httpsport = 0 Ä #txtporthttps$ = "00"
 Ä<(ddValue$,portinputname$,";")
 Ä addItemsToDropDown("ddportInput", ddValue$, portinput)
 Ä<(ddValue$,portoutputname$,";")
 Ä addItemsToDropDown("ddportOutput", ddValue$, portoutput)
 Ä<(ddValue1$,rs485name$,";")
 Ä addItemsToDropDown("ddportRS485", ddValue1$, rs485)
 ÄC
 Ä("unable to fetch PORT details")
 ÄD
 ...
 * Description: Ä this Ä Ä enable / Disable network Controls
 ...
 ***********************************************************/
Äh disableNetwork(dimi disableFlag) 
 ...
 * Description: Ä this Ä Ä remove prefix zeor's from the ip address
 *
 * Params:
 ...
 * History: 
 ***********************************************************/
Ä suppressZero$(dims ipAddress$) 
 dimi i,splitCount
 dims splitArray$,ResArray$(4),temp$
 splitCount = Ä<(splitArray$,ipAddress$,".")
 ÄB splitCount = 4 Ä
 
 Ä i = 0 Ä splitCount-1
 ResArray$(i) = strtoint(splitArray$(i)) 
 temp$ += ResArray$(i)+"."  
 Ä  
 
 suppressZero$ = Äå(temp$,Ä (temp$)-1)
 ÄC 
 ...
 * Description: Ä cancel the changed values and show the 
 ...
 * Description: * Ä Validate the textbox controls when the
 key press event is fired
 * Method getSubMenu_Keypress is used Ä get
 the Äh menu index
 * 
 * Params:
...
Äh Form_KeyPress(Key, FromMouse) 
 ...
 ÄB Ä&(ctrlName$,"ftp")<> -1 Ä
 FTPIdx = 4
 Äy Ä&(ctrlName$,"sntp")<> -1 Ä
 SNTPIdx = 8
 Äy Ä&(ctrlName$,"smtp")<> -1 Ä
 SMTPIdx = 6
 Äy Ä&(ctrlName$,"port")<> -1 Ä
 PortIdx = 10
 Äy Ä&(ctrlName$,"rtsp")<> -1 Ä
 RTSPIdx = 12
 Äy Ä&(ctrlName$,"network")<> -1 Ä
 networkIdx = 2
 ÄC
 networkIdx = 2
 ÄD
 ...
 * Description: Ä check the whether the IP is valid or not
 * 
 * Params:
 ...
 * History: 
 ***********************************************************/
Ä IP_Validation(Dims ipadd$,Dims fieldname$)
 Dims ArrNum$
 Dimi i 
 ÄB ipadd$<>"" and fieldname$<>"" Ä
 Ä<(ArrNum$,ipadd$,".")
 Ä i = 0 Ä ÄÇ(ArrNum$)
 Ä ArrNum$(i);ipadd$
 ÄB Ä(ArrNum$(i))>255 and ipadd$<>"" Ä
 Ä("Invalid " + fieldname$)
 Ä 1
 ÄD
 Ä
 ...
 * Description: 
 * Ä check whether the entered email ID is valid or not
 * Params:
 * emailID$: String - Email ID value
 * Created by: Franklin On 2008-07-21 15:03:00
 ***********************************************************/
Ä emailValidation(dims emailID$) 
 dimi loopCnt  
 dimi emaillen  
 dimi atcnt  
 dimi dotcnt  
 ...
 emailValidation = 1  
 emaillen = Ä (Ä#(emailId$)) 
 ÄB emailId$(0) = "@" or emailId$(0) = "_" or emailId$(0) = "-" or emailId$(0) = "." Ä
 emailValidation = 0 
 Ä
 ÄC
 Ä loopCnt = 0 Ä emailLen-1  
 
 ÄB (emailId$(loopCnt) >= ÄQ(65) and emailId$(loopCnt) <= ÄQ(90)) or (emailId$(loopCnt) >= ÄQ(97) and emailId$(loopCnt) <= ÄQ(122)) or (emailId$(loopCnt) >= ÄQ(48) and emailId$(loopCnt) <= ÄQ(57)) or emailId$(loopCnt) = ÄQ(46) or emailId$(loopCnt) = ÄQ(64) or emailId$(loopCnt) = ÄQ(45) or emailId$(loopCnt) = ÄQ(95) Ä
 emailValidation = 1  
 ÄC
 emailValidation = 0
 Ä
 ÄD 
 Ä emailId$(loopCnt) = "@" Ä atcnt++ 
 ÄB emailId$(loopCnt) = "." Ä 
 dotcnt++
 ÄB dotcnt = 1 Ä
 nextpos = loopcnt + 1
 ÄB emailId$(nextpos) = "." Ä
 emailValidation = 0
 Ä
 ÄD
 ÄD
 ...
 ÄB atcnt = 1 and dotcnt >= 1 and dotcnt <= 3 Ä
 emailValidation = 1
 ÄC
 emailValidation = 0
 ÄD
 ...
 * Description: 
 * Ä check whether the entered smtp server ip is valid or not
 * Params:
 * serverip$: String - server IP value
 * Created by: Franklin On 2008-07-21 15:03:00
 ***********************************************************/
Ä smtpServerIPValidation(dims serverip$) 
 dimi loopCnt  
 dimi serverlen  
 dimi atcnt  
 dimi dotcnt  
 ...
 serverlen = Ä (Ä#(serverip$)) 
 ÄB serverip$(0) = "@" or serverip$(0) = "_" or serverip$(0) = "-" or serverip$(0) = "." Ä
 smtpServerIPValidation = 0 
 Ä
 ÄC
 ÄB (serverip$(serverlen-1) = ".") Ä
 smtpServerIPValidation = 0
 Ä
 ÄD
 Ä loopCnt = 0 Ä serverlen-1  
 
 ÄB (serverip$(loopCnt) >= ÄQ(64) and serverip$(loopCnt) <= ÄQ(90)) or (serverip$(loopCnt) >= ÄQ(97) and serverip$(loopCnt) <= ÄQ(122)) or serverip$(loopCnt) = ÄQ(46) or serverip$(loopCnt) = ÄQ(45) or (serverip$(loopCnt) >= ÄQ(48) and serverip$(loopCnt) <= ÄQ(57)) Ä
 smtpServerIPValidation = 1  
 ÄC
 smtpServerIPValidation = 0
 Ä
 ÄD  
 ÄB serverip$(loopCnt) = "." Ä 
 dotcnt++
 ÄB dotcnt = 1 Ä
 nextpos = loopcnt + 1
 ÄB serverip$(nextpos) = "." Ä
 smtpServerIPValidation = 0
 Ä
 ÄD
 ÄD
 ...
 * ÄB failed Ä save throught the err msg.
 * Params:
 ...
 * Description: 
 * set the network, FTP, SMTP, port details Ä the Camera
...
Äh savePage()
 ...
 error$ = ""
 Ä validateNetwork()=0 Ä Ä
 Ä validateFTP()=0  Ä Ä
 Ä validateSMTP()=0  Ä Ä
 Ä validatePort()=0 Ä Ä
 ...
 error$ += ~errorKeywords$ 
 tempIp$ = ~camAddPath$
 ÄB retNW < 0 and retFTP >= 0 and retSMTP>=0 and retVal>=0  Ä
 ÄB #txtporthttp <> 80 Ä 
 ~camAddPath$ = "http://"+Ä#(#txtIPaddress$)+":"+#txtporthttp+"/" 
 ÄC
 ~camAddPath$ = "http://"+Ä#(#txtIPaddress$)+"/" 
 ÄD
 retNW  = Ä5(~camAddPath$+"vb.htm?getalarmstatus","","result.txt",2,SUPRESSUI,~authHeader$,,,responseData$) 
 HttpDNLDAbort(-1, 2, 0)
 
 
 
 ÄB tempIp$ <> ~camAddPath$ Ä
 ipFlag = 1
 ÄD
 ÄD  

 ÄB retFTP >= 0 and retSMTP>=0 and retVal>=0  Ä  
 saveSuccess = 1  
 ÄC 
 saveSuccess = 0
 ÄD
...
Äh displaySaveStatus(dimi saveStatus)
 ...
 ÄC  
 ÄB ~keywordDetFlag = 1 Ä  
 Ä("Network setting for \n"+error$+"\nfailed for the camera "+~title$)
 ÄC
 Ä("Network setting failed for the camera "+~title$)
 ÄD
 ÄD
 Ä ShowDefaultValues() 
...
Ä validateNetwork()
 validateNetwork=1
 ÄB #txtIPaddress$="" Ä
 Ä("IP address is a mandatory field")
 validateNetwork=0
 Äd("txtIPaddress")
 Ä
 Äy  IP_Validation(#txtIPaddress$,"IP Address") = 1 Ä
 validateNetwork=0
 Äd("txtIPaddress")
 Ä
 Äy #txtnetmask$="" Ä
 Ä("Sub netmask is a mandatory field")
 validateNetwork=0
 Äd("txtnetmask")
 Ä
 Äy #txtgateway$="" Ä 
 Ä("Default gateway is a mandatory field")
 validateNetwork=0
 Äd("txtgateway")
 Ä
 Äy #txtserver$="" Ä
 Ä("Primary server is a mandatory field")
 validateNetwork=0
 Äd("txtserver")
 Ä'
 Äy IP_Validation(#txtnetmask$,"subnet mask name") = 1 Ä  
 validateNetwork=0
 Äd("txtnetmask")
 Ä
 Äy IP_Validation(#txtgateway$,"gateway name") = 1 Ä  
 validateNetwork=0
 Äd("txtgateway")
 Ä
 Äy IP_Validation(#txtserver$,"primary server name") = 1 Ä  
 validateNetwork=0
 Äd("txtserver")
 Ä
 ÄD
...
Ä validateFTP()
 validateFTP=1
 ÄB #txtftpserver$="" Ä
 Ä("FTP server is a mandatory field")
 validateFTP=0
 Äd("txtftpserver")
 Ä
 Äy #txtftpusername$="" Ä
 Ä("FTP username is a mandatory field")
 validateFTP=0
 Äd("txtftpusername")
 Ä
 Äy Ä (#txtftpusername$) < minNameLen or Ä (#txtftpusername$) > maxNameLen Ä
 Ä("User name should have minimum of "+minNameLen+" characters and \n maximum of "+maxNameLen+" characters")
 validateFTP=0
 Äd("txtftpusername")
 Ä
 Äy #txtftppassword$="" Ä 
 Ä("FTP password is a mandatory field")
 validateFTP=0
 Äd("txtftppassword")
 Ä
 Äy Ä (#txtftppassword$) < minPwdLen or Ä (#txtftppassword$) > maxPwdLen Ä
 Ä("Password should have minimum of "+minPwdLen+" characters and \n maximum of "+maxPwdLen+" characters")
 validateFTP=0
 Äd("txtftppassword")
 Ä  
 Äy #txtftpport$="" Ä
 Ä("FTP port is a mandatory field")
 validateFTP=0
 Äd("txtftpport")
 Ä
 Äy IP_Validation(#txtftpserver$,"ftp server name") = 1 Ä  
 validateFTP=0
 Äd("txtftpserver")
 Ä  
 ÄD
...
Ä validateSMTP()
 validateSMTP=1
 ÄB #txtsmtpaccountname$="" Ä
 Ä("Account name is a mandatory field")
 validateSMTP=0
 Äd("txtsmtpaccountname")
 Ä
 Äy Ä (#txtsmtpaccountname$) < minNameLen or Ä (#txtsmtpaccountname$) > maxNameLen Ä
 Ä("User name should have minimum of "+minNameLen+" characters and \n maximum of "+maxNameLen+" characters")
 validateSMTP=0
 Äd("txtsmtpaccountname")
 Ä
 Äy #txtsmtppassword$="" Ä
 Ä("Password is a mandatory field")
 validateSMTP=0
 Äd("txtsmtppassword")
 Ä
 Äy Ä (#txtsmtppassword$) < minPwdLen or Ä (#txtsmtppassword$) > maxPwdLen Ä
 Ä("Password should have minimum of "+minPwdLen+" characters and \n maximum of "+maxPwdLen+" characters")
 validateSMTP=0
 Äd("txtsmtppassword")
 Ä  
 Äy #txtsmtpsender$="" Ä
 Ä("Sender is a mandatory field")
 validateSMTP=0
 Äd("txtsmtpsender")
 Ä
 Äy #txtsmtpserver$="" Ä 
 Ä("SMTP server is a mandatory field")
 validateSMTP=0
 Äd("txtsmtpserver")
 Ä
 Äy #txtsmtpport$="" Ä
 Ä("SMTP port is a mandatory field")
 validateSMTP=0
 Äd("txtsmtpport")
 Ä  
 Äy #txtsmtpemail$="" Ä
 Ä("Email is a mandatory field")
 validateSMTP=0
 Äd("txtsmtpemail")
 Ä
 ÄD
 ÄB Ä#(#txtsmtpsender$) <> "" and Ä#(#txtsmtpsender$) <> "0" Ä  
 ÄB emailValidation(Ä#(#txtsmtpsender$))=0  Ä 
 validateSMTP=0
 Ä("Sender Email ID should be in correct format")
 Äd("txtsmtpsender")
 Ä
 ÄD  
 ÄD
 ÄB smtpServerIPValidation(Ä#(#txtsmtpserver$))=0 Ä  
 validateSMTP=0
 Ä("SMTP Server should be in correct format")
 Äd("txtsmtpserver")
 Ä
 ÄD
 ÄB Ä#(#txtsmtpemail$) <> "" and Ä#(#txtsmtpemail$) <> "0" Ä  
 ÄB emailValidation(Ä#(#txtsmtpemail$))=0  Ä 
 Ä("Email ID should be in correct format")
 Äd("txtsmtpemail")
 Ä
 ÄD
 ÄD
...
Ä validatePort() 
 validatePort=1
 Ä Ä (#txtporthttp$)
 ÄB #txtporthttp$<>"" and Ä (#txtporthttp$)<2 or  Ä (#txtporthttp$)>5 Ä 
 Ä("Invalid http port number")
 validatePort=0
 Äd("txtporthttp")
 Ä
 Äy #txtporthttps$<>"" and Ä (#txtporthttps$)<2 or  Ä (#txtporthttps$)>5 Ä
 Ä("Invalid https port number")
 validatePort=0
 Äd("txtporthttps")
 Ä
 ÄD 
 ...
 * Description: Ä1 tab image based on the idx value set
...
Äh txtsmtpsender_Focus
 rule = 13
ÄF

Äh txtsmtpsender_blur
 rule=0
ÄF


Äh txtsmtpemail_Focus
 rule = 13
ÄF

Äh txtsmtpemail_blur
 rule = 0
ÄF
...
Äh chkrtspmulticast_Focus
 
 Ä∂(1)
ÄF

Äh chkrtspmulticast_blur  
 Ä∂(3)
ÄF
