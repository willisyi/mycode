...
Maximum of 10 users can be added Ä the camera.
User authourity can be set Ä each user.
...
LabelName$(0) = "txtusername" : XPos(0) = 544: YPos(0) = 86: Wdh(0) = 159: Height(0) = -1
LabelName$(1) = "newpassword" : XPos(1) = 544: YPos(1) = 121: Wdh(1) = 159: Height(1) = -1
LabelName$(2) = "pwdconfirm" : XPos(2) = 544: YPos(2) = 153: Wdh(2) = 159: Height(2) = -1
LabelName$(3) = "optauthority" : XPos(3) = 544: YPos(3) = 188: Wdh(3) = 75: Height(3) = 14
LabelName$(4) = "optauthority[1]" : XPos(4) = 627: YPos(4) = 188: Wdh(4) = 82: Height(4) = 14
LabelName$(5) = "optauthority[2]" : XPos(5) = 716: YPos(5) = 188: Wdh(5) = 67: Height(5) = 14
LabelName$(6) = "cmdSave" : XPos(6) = 544: YPos(6) = 232: Wdh(6) = 80: Height(6) = 20
LabelName$(7) = "cmdcancel" : XPos(7) = 629: YPos(7) = 232: Wdh(7) = 80: Height(7) = 20
LabelName$(8) = "eguserlist" : XPos(8) = 336: YPos(8) = 268: Wdh(8) = 582: Height(8) = 291
LabelName$(9) = "lblusername" : XPos(9) = 403: YPos(9) = 86: Wdh(9) = 127: Height(9) = 14
LabelName$(10) = "lblpwd" : XPos(10) = 403: YPos(10) = 121: Wdh(10) = 127: Height(10) = 14
LabelName$(11) = "lblconfirmpwd" : XPos(11) = 403: YPos(11) = 153: Wdh(11) = 127: Height(11) = 14
LabelName$(12) = "lblauthority" : XPos(12) = 403: YPos(12) = 188: Wdh(12) = 80: Height(12) = 14

dimi authorityAdmin  
dimi authorityOperator  
dimi authorityViewer  
 ...
 * Description: Ä this Ä Ä fetch user details from the camera
...
Äh fetchUserDetails
 ...
 sptidx = Ä<(authname$,authority$(i),":")
 ÄB sptidx = 2 Ä 
 authourityname$ = getauthority$(Ä(authname$(1)))
 ÄB  username$(1)<>"" and authourityname$ <> "" Ä
 ÄB Ä7(username$(1)) = "ADMIN"  Ä
 #eguserlist.addrow(username$(1)+ÄQ(255)+authourityname$+ÄQ(255)+ÄQ(255)+ÄQ(255)+Ä(authname$(1)))
 Äy  Ä7(username$(1)) = Ä7(~authUserName$) Ä 
 #eguserlist.addrow(username$(1)+ÄQ(255)+authourityname$+ÄQ(255)+"Edit"+ÄQ(255)+ÄQ(255)+Ä(authname$(1)))
 ÄC
 #eguserlist.addrow(username$(1)+ÄQ(255)+authourityname$+ÄQ(255)+"Edit"+ÄQ(255)+"Delete"+ÄQ(255)+Ä(authname$(1)))
 ÄD  
 ÄD
 ÄD
 ÄD
 ...
 * Ä setGridSettings Ä Ä set egrid settings
 * and Ä fetchUserDetails Ä Ä fetch and display 
 ...
 * Description: Ä this Ä Ä set column names,column widths 
 * and other egird properties.
 
 * Created by: vimala On 2009-03-17 12:57:00
 ***********************************************************/
Äh setGridSettings  
 #eguserlist.coldelim$ = ÄQ(255)
 #eguserlist.colnames$ = "User Name"+ÄQ(255)+"Authority"+ÄQ(255)+"Edit"+ÄQ(255)+"Delete"+ÄQ(255)+"Authid"
 #eguserlist.fldwidth(0) = 206 * ~factorX
 ...
 #eguserlist.showscroll = 0
 #eguserlist.rowheight  = 25
 #eguserlist.brdr  = 35
 #eguserlist.bg  = 2245
 #eguserlist.selbg  = 2245
 #eguserlist.selbrdr  = 35
 #eguserlist.font  = 7
 #eguserlist.cellbrdr  = 19216  
ÄF

/***********************************************************

 * Description: Ä this Ä Ä clear all the control values.
 
 * Created by: vimala On 2009-03-17 12:58:42
 ***********************************************************/
Äh clearControlValue() 
 #txtusername$ = ""
 #newpassword$ = ""
 #pwdconfirm$ = "" 
 #optauthority$ = "0" 
 ...
 * Description: Ä savePage Ä add users Ä camera
 ...
 * Description: Checks Ä mandatory fields
 * Add user Ä the camera and Ä egrid.
...
Äh savePage()
 ...
 Ä validateuserdetails() = 0 Ä Ä
 ~debugInfo$ += "Add User \n"
 ÄB #eguserlist.rowcount < maxaccount Ä 
 authourityname$ = getauthority$(#optauthority)
 
 Ä i = 0 Ä #eguserlist.rowcount-1  
 ÄB #txtusername$ = #eguserlist$(i,0) Ä  
 userExistFlag = 1 
 ÄE
 ÄD
 Ä
 
 ÄB userExistFlag = 1 and editFlag = 0 Ä
 ÄB Ä("User already exist.Do you want to replace?",3) = 0 Ä
 clearControlValue() 
 Ä  
 ÄC
 editFlag = 1  
 ...
 ÄB Ä#(#txtusername$)<>"" and Ä#(#newpassword$)<>"" and Ä#(#optauthority$)<>"" Ä
 retVal = addUser(#txtusername$,#newpassword$,#optauthority)
 ÄC 
 Ä("unable to add user")
 Ä  
 ÄD
 
 ÄB retVal=0 Ä 
 Ä("Added the user "+#txtusername$+" in the camera") 
 ÄB editFlag = 1  and ~authUserName$=Ä#(#txtusername$) Ä
 ~authUserName$ = Ä#(#txtusername$)
 ~authPassword$ = Ä#(#newpassword$)
 dimi ret
 ret = dwnldIniFile()
 ÄB ret < 0 Ä 
 Ä "Login Failed"
 ...
 fetchUserDetails()
 ÄC 
 Ä("Could not create user in the camera") 
 ÄD  
 
 ÄC 
 Ä("Number of users should not exceed "+maxaccount)
 ÄD
 ...
 * Description: Ä this Ä Ä check Ä mandatory fields.
 * Checks Ä valid input.
 
 * Created by: vimala On 2009-03-17 14:24:25
 ***********************************************************/
Ä  validateuserdetails  
 ...
 validateuserdetails = 0
 Ä  
 /*Äy Ä (Ä#(#txtusername$))<minNameLen Ä
 Ä("User name should have minimum of "+minNameLen+" characters")
 Äd("txtusername")
 validateuserdetails = 0
 Ä  
 Äy Ä (Ä#(#password$))<minPwdLen Ä
 Ä("Password should have minimum of "+minPwdLen+" characters")
 Äd("password")
 validateuserdetails = 0
 Ä  */
 Äy Ä (#txtusername$) < minNameLen or Ä (#txtusername$) > maxNameLen Ä
 Ä("User name should have minimum of "+minNameLen+" characters and \n maximum of "+maxNameLen+" characters")
 validateuserdetails=0
 Äd("txtusername")
 Ä
 Äy Ä (#newpassword$) < minNameLen or Ä (#newpassword$) > maxNameLen Ä
 Ä("Password should have minimum of "+minPwdLen+" characters and \n maximum of "+maxPwdLen+" characters")
 validateuserdetails=0
 Äd("newpassword")
 Ä
 Äy Ä#(#newpassword$) <> Ä#(#pwdconfirm$) Ä  
 Ä("Password mismatch")
 Äd("pwdconfirm")
 validateuserdetails = 0
 Ä  
 ...
 * Description: Ä returns authority name by passing authority id.
 * 0 - Admin
 * 1 - Operator
 * 2 - Viewer
 * Params:
 * dims authorityid$: String - Authority ID
 * Ä Value : Returns Authority Name.
 * Created by: vimala On 2009-03-17 14:25:41
 ***********************************************************/
Ä getauthority$(dims authorityid$) 
 dims authority$
...
Äh eguserlist_Click  
 ...
 ÄB #eguserlist.rowcount > 0 and #eguserlist.selrow >= 0 and #eguserlist.selcol >= 0  Ä
 
 ÄB #eguserlist$(intSelRow,intSelCol) = "Edit" Ä
 #txtusername$ = #eguserlist$(intSelRow,0)
 #optauthority$ = #eguserlist$(intSelRow,4)
 #newpassword$ = ""
 #pwdconfirm$ = ""
 editFlag = 1
 ÄB Ä7(#txtusername$) = Ä7(~authUserName$) Ä 
 disableCtrls(1)
 ÄC 
 disableCtrls(0)
 ÄD
 Äy  #eguserlist$(intSelRow,intSelCol) = "Delete" Ä  
 Ä("Do you really want to delete the user?",3)
 
 ÄB Äu()=1 Ä
 retVal = deleteUser(#eguserlist$(intSelRow,0))
 
 ÄB retVal=0 Ä 
 Ä("Deleted the user successfully in the camera")
 #eguserlist.deleterow(intSelRow)
 Ä clearControlValue()
 Äy retVal=-11 Ä 
 Ä("Users not able to delete onself")
 ÄC
 Ä("Could not delete the user in the camera")
 ÄD  
 ...
 * History: 
 ***********************************************************/
Äh disableCtrls(dimi disableFlag)
 ...
 * Description: Ä clearControlValue Ä Ä clear all control values.
...
Äh txtUserName_Focus
 rule = 5  
 Ä∂(3) 
ÄF

Äh newpassword_Focus
 rule = 5  
ÄF
...
Äh optauthority_Focus
 Ä∂(1)
ÄF

Äh optauthority_blur
 Ä∂(3)
ÄF
